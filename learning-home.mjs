...
export function buildLearningSnapshot({catalog,curriculum,storage,now=new Date()}){
  ...
  return {
    ...
    objectiveAnalytics,diagnosticTargets,xpLedger,xpTotal:xpLedger.totalXp,analystLevel,
